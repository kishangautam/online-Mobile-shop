...
<%@ page import="java.sql.*" %>
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="HTC One X9">HTC One X9</input></center></h1>
  <td width="10" height="10"><img src="images/htc/htc-one-x9-na-original-imaekrkbuddmgzjc.jpeg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5>
  lolipop 5.0.2</input>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="HTC One X9"></input>
