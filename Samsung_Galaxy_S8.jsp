...
<table width="1200" height="102" border="0">
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="HTC Desire 828">Samsung Galaxy S8</input></center></h1>
  <td width="10" height="10"><img src="images/_20170426_084955.jpg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h3>
  lolipop 5.0.2</input>
