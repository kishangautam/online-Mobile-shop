...
<%@ page import="java.sql.*" %>
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="Samsung Galaxy Grand">Samsung Galaxy Grand</input></center></h1>
  <td width="10" height="10"><img src="images/samsung/in_GT-I9082EWAINU_000000001_Front_white.jpg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5>
  lolipop 5.0.2</input>
 ...
 <h2><center><font color="lightGreen"><a href="spec3ss.jsp">Full Technical Descaription</a><br><br>
 <table align="center">
 <td>
 <center>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="Samsung Galaxy Grand"></input>
