...
<%@ page import="java.sql.*" %>
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="Nokia Lumiam 530DS">Nokia Lumiam 530DS</input></center></h1>
  <td width="10" height="10"><img src="images/nokia/1-45a7e.JPG" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5>
  window 10</input>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="Nokia Lumiam 530DS"></input>
