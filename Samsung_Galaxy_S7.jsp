...
<%@ page import="java.sql.*" %>
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="Samsung Galaxy S7">Samsung Galaxy S7</input></center></h1>
  <td width="10" height="10"><img src="images/samsung/samsung-galaxy-s7-usa.jpg" width="400" height="500" />
  </td>
  <td><h3><center>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="Samsung Galaxy S7"></input>
