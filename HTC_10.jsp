...
<%@ page import="java.sql.*" %>
   ...
   try{
       ...
       Class.forName("oracle.jdbc.driver.OracleDriver");
        conn=DriverManager.getConnection("jdbc:oracle:thin:@YOGI-PC:1521:xe","system","12345");
		 ...
		 String a="HTC 10 Topaz Gold 32 GB";
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="HTC 10 (Topaz Gold, 32 GB)">HTC 10 (Topaz Gold, 32 GB)</input></center></h1>
  <td width="10" height="10"><img src="images/htc/htc-10-na-original-imaek6jxbm5vf9vg.jpeg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5>
  lolipop 5.0.2</input>
 ...
 </table>  <h2><center><font color="lightGreen"><a href="spec2h.jsp">Full Technical Descaription</a><br><br>
 <table align="center">
 <td>
 <center>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="HTC 10 (Topaz Gold, 32 GB)"></input>
