...
<%@ page import="java.sql.*" %>
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="Sony Xperia z5">Sony Xperia z5</input></center></h1>
  <td width="10" height="10"><img src="images/sony/sony-xperia-z5-premium-e6683-original-imaeca2ydzbecxgr.jpeg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5>
  lolipop 5.0.2
 ...
 </table>  <h2><center><font color="lightGreen"><a href="spec2s.jsp">Full Technical Descaription</a><br><br>
 <table align="center">
 <td>
 <center>
 <button type="submit"><img width="150" height="80" src="images/Buylogo.jpg"/></button>
 </center></td>
</form>    <form action="AddtoCart.jsp">
	<td>
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="Sony Xperia z5"></input>
