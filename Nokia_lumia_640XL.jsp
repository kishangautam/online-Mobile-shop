...
<%@ page import="java.sql.*" %>
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="Nokia Lumiam 640XL">Nokia Lumiam 640XL</input></center></h1>
  <td width="10" height="10"><img src="images/nokia/51wsIF5fSyL._SX342_.jpg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5>
  window 10</input>
 ...
 </table>  <h2><center><font color="lightGreen"><a href="spec3n.jsp">Full Technical Descaription</a><br><br>
 <table align="center">
 <td>
 <center>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="Nokia Lumiam 640XL"></input>
