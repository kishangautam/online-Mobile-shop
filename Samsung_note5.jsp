...
<%@ page import="java.sql.*" %>
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="Samsung Galaxy Note5">Samsung Galaxy Note5</input></center></h1>
  <td width="10" height="10"><img src="images/samsung/gallery-1459802873-samsung-galaxy-note5.jpg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5><input type="hidden" name="os" value="lolipop 5.0.2">
  lolipop 5.0.2</input>
  </h5> </br>
 ...
 <h2><center><font color="lightGreen"><a href="spec2ss.jsp">Full Technical Descaription</a><br><br>
 <table align="center">
 <td>
 <center>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="Samsung Galaxy Note5"></input>
