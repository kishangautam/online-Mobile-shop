...
<%@ page import="java.sql.*" %>
   ...
   try{
       ...
       Class.forName("oracle.jdbc.driver.OracleDriver");
        conn=DriverManager.getConnection("jdbc:oracle:thin:@YOGI-PC:1521:xe","system","12345");
		 ...
		 String a="HTC Desire 828 Dual Sim";
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="HTC Desire 828">HTC Desire 828</input></center></h1>
  <td width="10" height="10"><img src="images/htc/htc-desire-828-dual-sim-na-original-imaednyszbqhmb6s.jpeg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5>
  lolipop 5.0.2</input>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="HTC Desire 828"></input>
